...
const onCancelOperation = (cancelFn) => {
...
export const promptSkillLocation = async (skillName, cwd, deps) => {
...
export const prepareSkillDir = async (skillDir, force, deps = {
    access: fs.access,
    rm: fs.rm,
    stat: fs.stat,
}) => {
...
export const resolveAndPrepareSkillDir = async (skillOutput, cwd, force) => {
