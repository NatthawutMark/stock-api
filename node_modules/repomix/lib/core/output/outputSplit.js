...
const renderGroups = async (groupsToRender, partIndex, rootDirs, baseConfig, gitDiffResult, gitLogResult, filePathsByRoot, emptyDirPaths, generateOutput) => {
    ...
    return await generateOutput(rootDirs, chunkConfig, chunkProcessedFiles, chunkAllFilePaths, partIndex === 1 ? gitDiffResult : undefined, partIndex === 1 ? gitLogResult : undefined, chunkFilePathsByRoot, emptyDirPaths);
};
