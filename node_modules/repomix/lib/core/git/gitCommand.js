...
export const execLsRemoteHead = async (url, deps = {
    execFileAsync,
}) => {
    validateGitUrl(url);
    try {
...
export const execGitShallowClone = async (url, directory, remoteBranch, deps = {
    ...
    if (remoteBranch) {
        ...
        try {
            await deps.execFileAsync('git', ['-C', directory, 'fetch', '--depth', '1', 'origin', '--end-of-options', remoteBranch], gitRemoteOpts);
...
export const validateGitRef = (ref) => {
    if (ref.startsWith('-')) {
